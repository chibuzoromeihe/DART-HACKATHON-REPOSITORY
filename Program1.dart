//This program displays personal information in one logical sentence.
void main() {
  String name = "Chibuzor Omeihe"; //defines variable for name

  int age = 29; //define variable for age
